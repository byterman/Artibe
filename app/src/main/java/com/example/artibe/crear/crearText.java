        ...
        btntext.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                final String aleatorio = elementos[p] + elementos[s] +
                        numero1 + elementos[t] + elementos[c] + numero2 + currentUser.getDisplayName().toString()+"blogtipotexto";

                Post post = new Post(tipo,texto.getText().toString(),"null","null",currentUser.getDisplayName().toString(),currentUser.getEmail().toString(),aleatorio);
                posts.add(post);
